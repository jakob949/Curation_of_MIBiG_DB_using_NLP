...
train_dataset = Dataset("dataset/smile_biosynclass/train_multi_0.txt", t5_tokenizer)
test_dataset = Dataset("dataset/smile_biosynclass/test_multi_0.txt", t5_tokenizer)
