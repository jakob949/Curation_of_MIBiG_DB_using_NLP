...
for epoch in range(num_epochs):
    ...
    t5_model.train()
    all_train_true_labels, all_train_predicted_labels, all_test_true_labels, all_test_pred_labels = [], [], [], []
    ...
    for batch in train_loader:
        ...
        with torch.no_grad():
            ...
            all_train_predicted_labels.extend(train_predicted_labels)
    ...
    for batch in test_loader:
        ...
        with torch.no_grad():
            ...
            all_test_pred_labels.extend(test_predicted_labels)
            all_test_true_labels.extend(test_true_labels)
